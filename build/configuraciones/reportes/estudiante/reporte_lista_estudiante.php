...
<html lang="es">
  ...
  <tr>
    ...
    if(isset($_POST['idimp'])){
        ...
        $con=conectarMysql();
        $consulta  = "SELECT es.carnet_es, es.nombre_es, es.apellido_es, es.genero_es, es.procedencia_es, fa.nombre_fa, ca.codigo_ca, ca.nombre_ca, pe.anio_pe FROM estudiante AS es, facultad AS fa, carrera AS ca, plan_estudio AS pe WHERE es.idestudiante=".$estudiante." AND es.idfacultad=fa.idfacultad AND es.idcarrera=ca.idcarrera AND es.idplan_estudio=pe.idplanestudio";
