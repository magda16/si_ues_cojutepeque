$(document).ready(function(){
  ...
  function ver(id){
    $.ajax({
          type: 'POST',
          url: '../../../produccion/administracion/aula/mostrar_aula.php',
          data: {'id': id}
        })
        .done(function(resultado_ajax){
          $('#insertarhtmlaula').html(resultado_ajax)
                    ...
                    .done(function(resultado_ajax){
                        if(resultado_ajax === "Exito"){
                            ...
                            swal({ 
                             ...
                             function(){
                                //event to perform on click of ok button of sweetalert
                                location.href='../../../produccion/administracion/aula/lista_aula_alta.php';
                            })
