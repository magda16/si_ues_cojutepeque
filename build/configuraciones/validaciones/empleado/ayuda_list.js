...
var tour = {
  ...
  steps: [
    ...
    },
    {
      ...
      content: 'Debe Dar Clic para Editar los Datos de el Recurso Humano.',
      placement: 'left'
    },
    {
      target: 'paso3',
      title: 'Dar Baja Recurso Humano',
      content: 'Debe Dar Clic para Dar Baja a los Datos de el Recurso Humano.',
      placement: 'left'
    }
  ],
  showPrevButton: true,
