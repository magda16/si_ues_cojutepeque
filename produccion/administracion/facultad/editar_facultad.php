<?php
    ...
    if(isset($_POST['id'])){
        $facultad = $_POST['id'];
        $con=conectarMysql();
        $consulta  = "SELECT fa.idfacultad, fa.nombre_fa, fa.telefono_fa, fa.correo_fa, fa.estado_fa, rf.nombre_rf, rf.apellido_rf FROM facultad as fa, representante_facultad as rf WHERE fa.id_re_fafk=rf.id_re_fa AND fa.idfacultad=".$facultad;
                  ...
                  <div class="x_content">
                    ...
                    <form id="formcarrera" name="formcarrera" method="POST" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" class="form-control has-feedback-left" id="telefono_f" name= "telefono_f" required="required" tabindex="1" placeholder="Digite Número de Teléfono" value="<?php echo $telefono; ?>">
