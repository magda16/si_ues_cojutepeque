                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li><a data-toggle="tooltip" data-placement="top" title="Reporte Facultad" href="../../../build/configuraciones/reportes/facultad/reporte_facultad.php"><i class="fa fa-print"></i></a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          ...
                          <th style="color: RGB(0, 0, 128);">Correo</th>
                          <th style="color: RGB(0, 0, 128);">Representante</th>
