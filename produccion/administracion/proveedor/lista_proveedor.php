                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <p class="text-muted font-13 m-b-30">
                      Lista de todas los Proveedores Activos.
                    </p>
                          ...
                          if ($result) {
                            while ($fila = $result->fetch_object()) {
                              ...
                              echo "<td> <a id='paso1' class='btn btn-success' type='button' onclick='ver(".$fila->idproveedor.")' data-toggle='tooltip' data-placement='top' title='Mostrar Proveedor'><i class='fa fa-eye'></i></a>
                                        <a id='paso2' class='btn btn-info' onclick='editarrepresentante(".$fila->idproveedor.")' data-toggle='tooltip' data-placement='top' title='Editar Proveedor'><i class='fa fa-edit'></i></a>";
                                        if($fila->editar=='si'){
