...
<html lang="es">
    ...
    <script type="text/javascript">
        ...
        function cancelar(){
          swal({ 
            ...
            function(){
              //event to perform on click of ok button of sweetalert
              location.href='registrar_proveedor.php';
            });
          });
        }
    </script>
  ...
  <body class="nav-md">
          ...
          <div class="col-sm-12 col-sm-offset-2 col-md-8 col-md-offset-2">
            ...
            <div class="row">
              <div class="col-sm-12 col-sm-offset-2 col-md-8 col-md-offset-2">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style="color:RGB(205, 92, 92);">Registrar Proveedor</h2>
    ...
    <script src="../../../build/configuraciones/validaciones/proveedor/validar_add.js"></script>
    <script src="../../../build/configuraciones/validaciones/proveedor/ayuda_add.js"></script>
  </body>
</html>
