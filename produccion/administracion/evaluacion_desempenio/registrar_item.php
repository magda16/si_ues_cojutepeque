...
<html lang="es">
  ...
  <body class="nav-md">
          ...
          <div class="col-sm-12 col-sm-offset-2 col-md-8 col-md-offset-2">
            ...
            <div class="row">
              <div class="col-sm-12 col-sm-offset-2 col-md-8 col-md-offset-2">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style="color:RGB(205, 92, 92);">Registro de Ítem por Aspecto a Evaluar</h2>
    ...
    <script src="../../../build/configuraciones/validaciones/evaluacion_desempenio/validar_add_item.js"></script>
